...
public class Infantry extends Unit {
    ...
    public void attack(Unit target) throws FriendlyFireException {
        ...
        if (target instanceof Archer) {
            ...
            switch (super.getLevel()) {
                case 1:
                    target.setCurrentSoldierCount((int) (target.getCurrentSoldierCount() - (this.getCurrentSoldierCount() * 0.1)));
                    break;
                case 2:
            ...
            switch (super.getLevel()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    target.setCurrentSoldierCount((int) (target.getCurrentSoldierCount() - (this.getCurrentSoldierCount() * 0.25)));
                    break;
            }
        }
